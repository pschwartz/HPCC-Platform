...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  option(WITH_CONFIGTOOLS "Enable the HPCC Config tools" ON)
  option(WITH_SERVERTOOLS "Enable server tools" ON)
  option(WITH_LINUX_INIT "Enable the building of the Linux init system" ON)
  
  option(CLIENTTOOLS_ONLY "Build only the client tools" OFF)
  if ( CLIENTTOOLS_ONLY )
	set(WITH_THOR OFF)
	set(WITH_ROXIE OFF)
	set(WITH_ECLAGENT OFF)
	set(WITH_ECLCCSERVER OFF)
	set(WITH_ECLSCHEDULER OFF)
	set(WITH_ESP OFF)
	set(WITH_DALI OFF)
	set(WITH_DFUSERVER OFF)
	set(WITH_SASHA OFF)
	set(WITH_SERVERTOOLS OFF)
	set(WITH_CONFIGTOOLS OFF)
  endif()
